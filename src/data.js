    ...
    works: [
      {
        ...
        location: "Remote",
        description:
          "A real estate platform created to facilitate property listings for users in the market.",
        achievements: [
      ...
      },
      {
        ...
        location: "Remote",
        description: "digitizes legal admin, streamlines committee requests, and manages legal forms.",
        achievements: [
        ...
        tags: ["JavaScript", "bootstrap", "jQuery", "Sass", "ASP.NET Core", "Partial Views"],
      },
    ],
  },
];
